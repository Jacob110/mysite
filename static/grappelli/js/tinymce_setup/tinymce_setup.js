...
tinyMCE.init({
    ...
    plugins: 'advimage,advlink,fullscreen,paste,media,searchreplace,grappelli,template,syntaxhl',
    // directionality : "rtl",
    ...
    style_formats : [
        {title : 'C/C++', block : 'pre', classes: 'brush: c;'},
        {title : 'Go', block : 'pre', classes: 'brush: go;'},
        {title : 'C#', block : 'pre', classes: 'brush: csharp;'},
        {title : 'Python', block : 'pre', classes: 'brush: python;'},
        {title : 'Java', block : 'pre', classes: 'brush: java;'},
        {title : 'JScript', block : 'pre', classes: 'brush: js;'},
    ...
    theme_advanced_buttons2: 'search,|,pasteword,template,media,charmap,|,code,|,table,cleanup,grappelli_documentstructure,|,syntaxhl',
